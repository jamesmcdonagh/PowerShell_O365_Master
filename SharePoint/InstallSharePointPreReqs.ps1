Start-Process "C:\SharePoint2016\PrerequisiteInstaller.exe" -ArgumentList "/SQLNCli:`"C:\SharePoint2016\PrerequisiteInstallerFiles\sqlncli.msi`" ` 
/Sync:`"C:\SharePoint2016\PrerequisiteInstallerFiles\Synchronization.msi`" ` 
/AppFabric:`"C:\SharePoint2016\PrerequisiteInstallerFiles\WindowsServerAppFabricSetup_x64.exe`" ` 
...
/DotNet452:`"C:\SharePoint2016\PrerequisiteInstallerFiles\NDP452-KB2901907-x86-x64-AllOS-ENU.exe`" ` 
